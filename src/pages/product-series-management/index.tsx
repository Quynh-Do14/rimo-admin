...
const ProductSeriesListPage = () => {
    ...
    const onGetListAsync = async ({ search = "", size = pageSize, page = currentPage }) => {
        ...
        try {
            await productSeriesService.GetProductSeries(
                param,
                setLoading
            ).then((res) => {
    ...
    const onDeleteAsync = async () => {
        try {
            await productSeriesService.DeleteProductAdmin(
                idSelected,
                setLoading
            ).then((res) => {
                if (res) {
    ...
    const onNavigate = (id: any) => {
        router(`${(ROUTE_PATH.VIEW_PRODUCT_SERIES_MANAGEMENT).replace(`${Constants.UseParams.Id}`, "")}${id}`);
    }
        ...
        >
            <div className={styles.manage_container}>
                ...
                <div className={styles.searchBar}>
                    ...
                    />
                    <ButtonHref
                        href={ROUTE_PATH.ADD_PRODUCT_SERIES_MANAGEMENT}
                        title={'Thêm mới'}
                        width={150}
                ...
                <DialogConfirmCommon
                    message={"Bạn có muốn xóa thông số này ra khỏi hệ thống"}
                    titleCancel={"Bỏ qua"}
                    titleOk={"Xóa"}
...
export default ProductSeriesListPage;