...
import { UpdateIndexCategoryInterface } from '../../infrastructure/interface/category/categoryProduct.interface';
import categoryProductService from '../../infrastructure/repository/category/categoryProduct.service';

const UpdateIndexCategoryManagement = () => {
    ...
    const [indexList, setIndexList] = useState<UpdateIndexCategoryInterface[]>([])
    const isValidData = () => {
    ...
    const onUpdateAsync = async () => {
        ...
        if (isValidData()) {
            try {
                await categoryProductService.UpdateIndexProductAdmin(
                    {
...
export default UpdateIndexCategoryManagement