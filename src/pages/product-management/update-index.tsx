...
import { ProductInterface, UpdateIndexProductInterface } from '../../infrastructure/interface/product/product.interface';
import productService from '../../infrastructure/repository/product/product.service';

const UpdateIndexProductManagement = () => {
    ...
    const [indexList, setIndexList] = useState<UpdateIndexProductInterface[]>([])
    const isValidData = () => {
    ...
    const onUpdateAsync = async () => {
        ...
        if (isValidData()) {
            try {
                await productService.UpdateIndexProductAdmin(
                    {
    ...
    return (
        <AdminLayout
            ...
            title={"Quản lý thứ tự sản phẩm"}
            redirect={ROUTE_PATH.PRODUCT_MANAGEMENT}
        >
            <div className={styles.manage_container}>
                <div className={styles.headerPage}>
                    <h2>Quản lý thứ tự sản phẩm</h2>
...
export default UpdateIndexProductManagement